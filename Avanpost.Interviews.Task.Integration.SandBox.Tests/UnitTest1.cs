...
namespace Avanpost.Interviews.Task.Integration.SandBox.Tests
{
    public class UnitTest1
    {
        ...
        static string mssqlConnectionString = "Data Source=DESKTOP-4V4BR0L;User=DESKTOP-4V4BR0L\\Misha;Initial Catalog=testDb;integrated security=True;TrustServerCertificate=true";
